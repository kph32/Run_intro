<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="photo.aspx.cs" Inherits="Introduce.photo" %>
			...
			<!-- Nav -->
				<nav id="nav">
					<ul>
						...
						<li><a href="photo.aspx" class="active"><span class="icon fa-camera-retro"></span></a></li>
					</ul>
				</nav>
									...
									<!-- Filters -->
										...
										<div class="content">
											<div class="media all people">
												<a href="images/fulls/03.jpg"><img src="images/thumbs/01.jpg" alt="" title="This right here is a caption." /></a>
											</div>
